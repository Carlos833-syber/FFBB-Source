...
override function update(elapsed:Float)
{
	...
	if (island != null && island.animation != null && island.animation.curAnim != null)
	{
		...
		if (island.animation.curAnim != null
			...
			&& !bubblesDone)
		{
			if (bubbles != null && bubbles.animation != null)
			{
				bubblesDone = true;
	...
	if (spongeDance != null && pineapple != null)
	{
	...
	if (selectedSomethin)
	{
		menuItems.forEach(function(spr:FlxSprite)
		{
			if (spr != null && curSelected == spr.ID)
			{
	...
	if (!skippedIntro)
	{
		switch (curBeat)
		{
			...
			case 14:
				...
				if (pineapple != null)
				{
					FlxTween.tween(pineapple, {y: -1920}, 1.2, {
...
{
	if (existingDifficulties == null || existingDifficulties.length == 0)
		return;
...
function transition()
{
	...
	if (bubbleEffect != null)
	{
		bubbleEffect.forEach(function(spr:FlxSprite)
		{
			if (spr != null)
			{
				FlxTween.tween(spr, {y: -100}, FlxG.random.float(0.8, 1.4), {
					ease: FlxEase.sineIn
				});
			}
		});
